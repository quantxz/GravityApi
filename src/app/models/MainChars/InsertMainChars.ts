...
export const createMainCharacters = async (data: mainCharsInterface) => {
    try {
        ...
        const values = [data.name, data.fisrt_episode, data.last_episode, data.voice, data.age, data.born, data.ocuppation, data.inspiration, data.likes, data.dislikes, data.description, data.image]
